...
class Day02 : Day<Int>(58, 34) {
    override fun part1(input: List<String>): Int = input.map { it.toCuboid() }.sumOf { it.surface + it.slack }

    override fun part2(input: List<String>): Int = input.map { it.toCuboid() }.sumOf { it.perimeter + it.volume }
}
